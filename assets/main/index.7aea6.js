window.__require = function e(t, n, r) {
  ...
  GameConstants: [ function(require, module, exports) {
    ...
    var MapConfig = function() {
      ...
      MapConfig.width = 3e3;
      MapConfig.height = 2500;
      MapConfig.mapScale = .1;
      MapConfig.lootItemId = {
        gun: 0,
        ammo: 1,
        chest: 2,
        helmet: 3
  ...
  LootItem: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "38f59nHmQ5LprWXQdEMnGS0", "LootItem");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var LootItem = function(_super) {
      __extends(LootItem, _super);
      function LootItem() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.bg = null;
        _this.item = null;
      ...
      LootItem.prototype.start = function() {
        var _this = this;
        cc.resources.load("loot/loot-circle-outer-01", cc.SpriteFrame, function(err, spriteFrame) {
          _this.bg.spriteFrame = spriteFrame;
        });
      };
      LootItem.prototype.setItemId = function(id) {
        var _this = this;
        var path = "";
        switch (id) {
         case GameConstants_1.MapConfig.lootItemId.gun:
         case GameConstants_1.MapConfig.lootItemId.ammo:
          path = "loot/loot-weapon-ak";
          break;

         case GameConstants_1.MapConfig.lootItemId.chest:
          path = "loot/loot-chest-01";
          break;

         case GameConstants_1.MapConfig.lootItemId.helmet:
          path = "loot/loot-helmet-01";
        }
        cc.resources.load(path, cc.SpriteFrame, function(err, spriteFrame) {
          _this.item.spriteFrame = spriteFrame;
        });
      };
      __decorate([ property(cc.Sprite) ], LootItem.prototype, "bg", void 0);
      __decorate([ property(cc.Sprite) ], LootItem.prototype, "item", void 0);
      LootItem = __decorate([ ccclass ], LootItem);
      return LootItem;
    }(cc.Component);
  ...
  MatchManager: [ function(require, module, exports) {
    ...
    var MatchManager = function() {
      ...
      MatchManager.prototype.calculateMovePlayer = function(newX, newY) {};
      return MatchManager;
    }();
  ...
  MatchScene: [ function(require, module, exports) {
    ...
    var MatchScene = function(_super) {
      ...
      MatchScene.prototype.genLootItem = function(x, y) {
        var randX, randY;
        if (void 0 === x) {
          var invalid = false;
          do {
            ...
            for (var _i = 0, _a = this.obstacles; _i < _a.length; _i++) {
              var obs = _a[_i];
              obs.checkCollisionCircle(28, randX, randY) && (invalid = true);
            }
          } while (invalid);
        } else {
          randX = x;
        ...
        var loot = cc.instantiate(this.lootItem);
        loot.getComponent(LootItem_1.default).setItemId(0);
      ...
      __decorate([ property(cc.Prefab) ], MatchScene.prototype, "lootItem", void 0);
    ...
    "./MapObject/LootItem": "LootItem",
    "./MapObject/Obstacle/Obstacle": "Obstacle",
    "./MiniMap": "MiniMap",
    "./Player": "Player"
  } ],
  ...
  NakamaConnectionData: [ function(require, module, exports) {
    ...
    var NakamaConnectionData = function() {
      function NakamaConnectionData(host, port, serverKey) {
        this.host = null;
        this.port = null;
        this.serverKey = null;
        this.host = host;
  ...
  NakamaManager: [ function(require, module, exports) {
    ...
    var NakamaManager = function() {
      function NakamaManager() {
        this.connectionData = new NakamaConnectionData_1.default("152.69.216.149", "7350", "defaultkey");
        this.client = null;
        this.session = null;
        this.socket = null;
      }
        ...
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            ...
            sessionTask.then(function(session) {
              ...
              _this.socket = _this.client.createSocket(false);
  ...
  Player: [ function(require, module, exports) {
    ...
    var Player = function(_super) {
      ...
      Player.prototype.toggleEquipGun = function() {
        ...
        MatchManager_1.MatchManager.getInstance().sendPlayerEquip(this.isEquip);
      };
...
}, {}, [ "GameConstants", "GameManager", "HomeScene", "UserInfo", "SceneChanger", "Initializer", "MatchManager", "MatchNetwork", "PlayerData", "PlayerLogic", "Bullet", "LootItem", "Bush", "Obstacle", "MatchScene", "MiniMap", "Player", "MultiplayerManager", "MultiplayerMessage", "NakamaAutoLogin", "NakamaConnectionData", "NakamaManager", "OperationCode", "RPCData", "EventHandler", "GameEventType", "LocalStorageKeys", "PersistNode", "RPCs" ]);
